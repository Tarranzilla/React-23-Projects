        ...
        >
            ...
            <div className="Robot_Info_Media_Container">
                <div className="Robot_Info_Image_Container">
                    <img src={Inspector} className="Robot_Info_Main_Image"></img>
                    <img src={InspectorBg} className="Robot_Info_Background_Image"></img>
                </div>
            </div>

            <div className="Robot_Info_Specs_Container">
                <div className="Specs_Title_Container">
                    <h1 className="Route_Title Specs_Title">INSPECTOR</h1>
