    ...
    return (
        <m.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="Help_Container">
            ...
            <p className="Checkout_Help_Text">
                Lá você poderá preencher seus dados pessoais de compra e o endereço de entrega com segurança e praticidade, podendo acompanhar o envio
            ...
            <a href="https://www.mercadopago.com.br/ajuda/dinheiro-seguranca-compras_328" target="_blank" rel="noopener" className="MercadoPago_Link">
