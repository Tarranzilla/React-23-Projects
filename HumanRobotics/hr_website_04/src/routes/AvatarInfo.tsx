        ...
        >
            ...
            <div className="Robot_Info_Media_Container">
                <div className="Robot_Info_Image_Container">
                    <img src={Avatar} className="Robot_Info_Main_Image"></img>
                    <img src={AvatarBg} className="Robot_Info_Background_Image"></img>
                </div>
            </div>

            <div className="Robot_Info_Specs_Container">
                <div className="Specs_Title_Container">
                    <h1 className="Route_Title Specs_Title">RobiOS Avatar</h1>
                    <h2 className="Specs_SubTitle">Especificações</h2>
                </div>

                <p className="Specs_Description">
                    Tenha acesso a todas as aplicações do RobiOS Avatar em qualquer dispositivo Android por meio do Avatar: Software exclusivo da
                    Human Robotics, ideal para recepções e auto-atendimentos simples.
                </p>
