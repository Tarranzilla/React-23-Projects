    ...
    return (
        <>
            <m.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="Route_Container Contato_Route">
                ...
                <div className="Form_Container Contato_Form_Container">
                    <form className="Form Form_Contato" id="form_contato" action="index.html" method="post">
                        <input type="text" placeholder="Nome" required className="first-input" />
                        <input type="email" placeholder="E-mail" required />
                        <input type="text" placeholder="Telefone" required />
                        <textarea name="message" id="message" rows={10} placeholder="Mensagem" required></textarea>
                        <button type="submit">Enviar Email</button>
                    </form>

                    <a className="contato-whats" href="https://api.whatsapp.com/send?phone=5541992923596&text=Ol%C3%A1" target="_blank">
